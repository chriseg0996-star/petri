    ...
    public static class DefLoader
    {
        ...
        private static Rules ParseRules(string json)
        {
            ...
            return new Rules
            {
                ...
                GrowthBeatTicks = GetInt(r, "growthBeatTicks", 4),
                ...
                SlowBeatTicks = GetInt(r, "slowBeatTicks", 20),
                HarvestBasePerBeat = GetInt(r, "harvestBasePerBeat", 4),
                HarvestPerWorker = GetInt(r, "harvestPerWorker", 2),
                HarvestNodeCapPerBeat = GetInt(r, "harvestNodeCapPerBeat", 25),
